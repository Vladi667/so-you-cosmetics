    ...
    return (
      <div className="min-h-screen bg-mist-white flex items-center justify-center px-6">
        <div className="text-center max-w-md">
          ...
          <Lien to="/journal" className="inline-block mt-4 px-8 py-3 bg-slate-stone text-white rounded-full text-xs uppercase tracking-widest hover:bg-slate-stone/90 transition-colors">
    ...
    return (
      <article className="min-h-screen bg-mist-white pt-28 sm:pt-36 pb-20">
        <div className="container mx-auto px-6 md:px-12 max-w-3xl">
          <Lien to="/journal" className="inline-block font-sans text-xs uppercase tracking-widest text-stone-gray hover:text-slate-stone transition-colors mb-8">
            ← {t('journal.backToList')}
          </Lien>
      ...
      <div className="container mx-auto px-6 md:px-12 max-w-5xl">
        ...
        {articles.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {articles.map((a) => (
              <Lien key={a.id} to={`/journal/${a.slug}`} className="group block">
