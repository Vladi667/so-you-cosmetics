          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-12 md:gap-20">
            ...
            <div className="reveal">
              ...
              <div className="space-y-4 sm:space-y-8">
                ...
                <div className="flex items-start gap-2 sm:gap-5 group">
                  ...
                  <div>
                    <h3 className="font-sans tracking-[0.1em] sm:tracking-[0.2em] text-[9px] sm:text-xs font-bold text-slate-stone mb-1 sm:mb-2 uppercase">Adresse</h3>
                ...
                <div className="flex items-start gap-2 sm:gap-5 group">
                  ...
                  <div>
                    <h3 className="font-sans tracking-[0.1em] sm:tracking-[0.2em] text-[9px] sm:text-xs font-bold text-slate-stone mb-1 sm:mb-2 uppercase">Téléphone</h3>
                ...
                <div className="flex items-start gap-2 sm:gap-5 group">
                  ...
                  <div>
                    <h3 className="font-sans tracking-[0.1em] sm:tracking-[0.2em] text-[9px] sm:text-xs font-bold text-slate-stone mb-1 sm:mb-2 uppercase">Email</h3>
            ...
            <div className="reveal" style={{ transitionDelay: '200ms' }}>
              <div className="bg-mist-white rounded-[16px] sm:rounded-[30px] md:rounded-[40px] p-4 sm:p-10 md:p-14 border border-slate-stone/5">
                <h3 className="font-serif text-base sm:text-2xl md:text-3xl text-slate-stone mb-4 sm:mb-10">Horaire d'ouverture</h3>
                ...
                <div className="mt-4 pt-4 sm:mt-10 sm:pt-10 border-t border-slate-stone/10 space-y-2 sm:space-y-6">
                  <div className="flex justify-between items-start">
                    <span className="font-sans text-[9px] sm:text-sm text-slate-stone/60 max-w-[80px] sm:max-w-[140px]">Si vous n'êtes pas du quartier</span>
                    <span className="font-sans text-[9px] sm:text-sm text-stone-gray font-light text-right">Prière de téléphoner à l'avance<br/>ou prenez un RDV</span>
                  </div>
                  <div className="flex justify-between items-start">
                    <span className="font-sans text-[9px] sm:text-sm text-slate-stone/60 max-w-[80px] sm:max-w-[140px]">En dehors de ces horaires</span>
                    <span className="font-sans text-[9px] sm:text-sm text-stone-gray font-light text-right">Par Chance ou Sur RDV</span>
                  </div>
                  <div className="flex justify-between items-start">
                    <span className="font-sans text-[9px] sm:text-sm text-slate-stone/60 max-w-[80px] sm:max-w-[140px]">Jours fériés, vacances</span>
                    <span className="font-sans text-[9px] sm:text-sm text-stone-gray font-light text-right">Prière consulter Google, pas<br/>de livraisons ni retraits ces jours</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 sm:py-32 bg-gradient-to-b from-mist-white to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-12 max-w-4xl relative z-10">
          <div className="text-center mb-10 sm:mb-20 reveal">
            <h2 className="font-serif text-3xl sm:text-5xl md:text-7xl text-slate-stone mb-3 sm:mb-6">Écrivez-nous</h2>
          ...
          <form onSubmit={handleSubmit} className="reveal bg-white rounded-[16px] sm:rounded-[30px] md:rounded-[40px] p-5 sm:p-10 md:p-16 shadow-[0_15px_50px_rgb(0,0,0,0.05)] border border-slate-stone/5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 mb-4 sm:mb-8">
              <div>
                <label className="block font-sans text-[10px] sm:text-xs tracking-[0.2em] uppercase font-bold text-slate-stone mb-1.5 sm:mb-3">Nom</label>
                <input
                  type="text"
                  value={formData.name}
              ...
              <div>
                <label className="block font-sans text-[10px] sm:text-xs tracking-[0.2em] uppercase font-bold text-slate-stone mb-1.5 sm:mb-3">Email</label>
                <input
                  type="email"
            ...
            <div className="mb-4 sm:mb-8">
              <label className="block font-sans text-[10px] sm:text-xs tracking-[0.2em] uppercase font-bold text-slate-stone mb-1.5 sm:mb-3">Sujet</label>
              <input
                type="text"
            ...
            <div className="mb-6 sm:mb-10">
              <label className="block font-sans text-[10px] sm:text-xs tracking-[0.2em] uppercase font-bold text-slate-stone mb-1.5 sm:mb-3">Message</label>
              <textarea
