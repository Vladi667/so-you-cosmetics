...
const WorkshopsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-mist-white overflow-hidden">
      ...
      {/* Hero Section — Will use video once generated, fallback to image */}
      <section className="relative h-[85vh] flex items-center justify-center">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center reveal mt-20">
          <p className="text-white/80 uppercase tracking-[0.5em] text-[10px] md:text-xs mb-8 font-sans font-bold">Expérience Artisanale</p>
        ...
        <div className="container mx-auto px-6 md:px-12 max-w-5xl">
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            <div className="w-full lg:w-1/2 reveal">
              <h2 className="font-serif text-5xl md:text-6xl text-slate-stone mb-12 leading-tight">
              ...
              <div className="space-y-8 font-sans text-stone-gray font-light leading-relaxed text-xl text-justify">
                ...
                <div className="relative py-10 px-10 bg-mist-white rounded-3xl border-l-8 border-slate-stone shadow-xl transform -rotate-1 my-10">
      ...
      <section className="py-32 bg-gradient-to-b from-mist-white to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="text-center max-w-4xl mx-auto mb-24 reveal">
            <h2 className="font-serif text-6xl md:text-7xl text-slate-stone mb-10">Les Détails</h2>
            ...
            {details.map((item, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="font-sans tracking-[0.2em] uppercase text-sm mb-4 font-bold text-slate-stone">
                    {item.label}
                  </h3>
                  <p className="font-serif text-2xl text-slate-stone/80 leading-relaxed">
                    {item.value}
                  </p>
                </div>
              </div>
      ...
      <section className="relative py-48 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center reveal">
          <h2 className="font-serif text-5xl md:text-7xl text-white mb-10 drop-shadow-lg">Réservez Votre Atelier</h2>
          <p className="font-sans text-white/80 text-xl md:text-2xl font-light mb-16 max-w-2xl mx-auto leading-relaxed">
            Contactez-nous pour de plus amples renseignements et réservez votre moment de création.
          </p>
          <a
            href="mailto:contact@soyou.ch"
            className="inline-block px-12 py-5 bg-white text-slate-stone font-sans uppercase tracking-[0.3em] text-sm hover:bg-slate-stone hover:text-white transition-all duration-500 shadow-xl rounded-full hover:scale-105 transform"
          >
            Nous Contacter
          </a>
        </div>
