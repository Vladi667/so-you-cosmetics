  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center px-4 max-w-4xl mx-auto flex flex-col items-center mt-20">
        ...
        <p className="font-sans text-lg md:text-xl text-ivory/90 mb-10 max-w-2xl opacity-0 animate-[fadeInUp_1.5s_ease-out_0.5s_forwards]" style={{ textShadow: '0 1px 12px rgba(0,0,0,0.4), 0 1px 4px rgba(0,0,0,0.2)' }}>
          Artisanal soaps, bath rituals, body care and botanical wellness crafted with Swiss purity.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-6 opacity-0 animate-[fadeInUp_2s_ease-out_1s_forwards]">
          <a href="#products" className="px-8 py-4 bg-white text-slate-stone font-sans uppercase tracking-[0.2em] text-xs hover:bg-slate-stone hover:text-white transition-all duration-500 shadow-lg rounded-full">
            Discover the Collection
          </a>
          <a href="#workshops" className="px-8 py-4 border border-white/50 text-white font-sans uppercase tracking-[0.2em] text-xs hover:bg-white/10 hover:border-white transition-all duration-500 backdrop-blur-sm rounded-full">
            Our Workshops
          </a>
        </div>
      </div>

      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center animate-pulse opacity-50 hover:opacity-100 transition-opacity duration-500 cursor-pointer">
